...
def employee_details_database():
    ...
    employee_details_engine = create_engine("postgresql://{user}:{pw}@localhost/{db}"
...
def employee_access_details_database():
    ...
    employee_access_details_engine = create_engine("postgresql://{user}:{pw}@localhost/{db}"
                       .format(user="postgres",
                               pw="root",
...
def admin_details_database():
    ...
    if os.path.exists(admin_details_path):
        admin_details_engine = create_engine("postgresql://{user}:{pw}@localhost/{db}"
                       .format(user="postgres",
                               pw="root",
                               db="admin_details"))
...
def employee_attendance_database():
    ...
    employee_attendance_engine = create_engine("postgresql://{user}:{pw}@localhost/{db}"
                       .format(user="postgres",
                               pw="root",
...
def main_attendance_database():
    ...
    main_attendance_engine = create_engine("postgresql://{user}:{pw}@localhost/{db}"
                       .format(user="postgres",
                               pw="root",
                               db="main_attendance"))
